...
/**
 * create database query for current properties
 * */
function setQuery(o) {
  const q = {};
...
/**
 * create database projection for current properties
 * */
...
function getRequestOptions(o) {
  return {
    method: 'GET',
    hostname: 'api.worldbank.org',
    path: `/v2/countries/${o.countries}/${o.indicator ? 'indicators/' + o.indicator : ''}?format=json${o.date ? '&data=' + o.date : ''}`
  };
}
