...
MWM.appl = function() {
	...
	this.res = "/obj/";
    this.colors = {
        basic : (new THREE.Color( 0xFF9999)),
...
MWM.appl.prototype = {
        ...
        _setIntersection : function(event){
	...
	showObject : function(ids, visible) {
    ...
    addObject : function(id, obj, intersect) {
        if (this.geometry.objects[id]) {
		...
		registerEventCallback: function(type, listener) {
		...
		addGrid: function(size, dimension) {
				        /*add base grid*/
		...
		createBufferedGeometry: function() {
			return new THREE.BufferGeometry();
		},

		createOneDimGraphicArray: function(length) {
			return new Float32Array( length );
		},

		createThreeDimGraphicArray: function(length) {
